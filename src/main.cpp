...
int main() {
    ...
    std::string csvPath = "C:/Users/daniel/Documents/merged_csvs/binance_depth_snapshot_difference_depth_stream_trade_stream_usd_m_futures_trxusdt_14-04-2025.csv";
